...
export const Header = () => {
  ...
  return (
    <Disclosure
      as="nav"
      className="bg-surface dark:bg-surface-dark border-b border-surface-variant dark:border-surface-variant-dark "
    >
      {({ open }) => (
        <>
          <div className="md:container md:mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <h1 className="absolute right-1 sm:right-0 text-lg sm:text-2xl text-primary dark:text-primary-dark">
                  catnapz
                </h1>
